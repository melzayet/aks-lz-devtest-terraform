...
module "aks" {
  ...
  pod_subnet_id      = data.terraform_remote_state.existing-lz.outputs.pod_subnet_id
  spotPod_subnet_id      = data.terraform_remote_state.existing-lz.outputs.spotPod_subnet_id
